...
const plans = [
  {
    name: "Free",
    description:
      "Great for freelancers just getting started with receipt tracking",
    price: 0,
    yearlyPrice: 0,
  ...
  },
  {
    name: "Pro",
    description:
      "Best for freelancers and solopreneurs who need unlimited access",
    price: 12,
    yearlyPrice: 120,
  ...
  },
  {
    name: "Business",
    description:
      "For teams and businesses with advanced expense management needs",
    price: 29,
    yearlyPrice: 290,
  ...
  return (
    ...
    >
      ...
      <article className="text-center mb-6 pt-32 max-w-3xl mx-auto space-y-2 relative z-50">
        ...
        >
          Choose the plan that fits your receipt tracking needs
        </TimelineContent>
